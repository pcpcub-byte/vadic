...
(() => {
    ...
    var t = {
        ...
        }), "solid", "regular", "light", "thin", "duotone", "brands", "2xs", "xs", "sm", "lg", "xl", "2xl", "beat", "border", "fade", "beat-fade", "bounce", "flip-both", "flip-horizontal", "flip-vertical", "flip", "fw", "inverse", "layers-counter", "layers-text", "layers", "li", "pull-left", "pull-right", "pulse", "rotate-180", "rotate-270", "rotate-90", "rotate-by", "shake", "spin-pulse", "spin-reverse", "spin", "stack-1x", "stack-2x", "stack", "ul", o.GROUP, o.SWAP_OPACITY, o.PRIMARY, o.SECONDARY].concat(c.map(t => "".concat(t, "x"))).concat(s.map(t => "w-".concat(t))),
    ...
    function O(t) {
        ...
        return "string" == typeof t ? wt(t) : "<".concat(e, " ").concat((a = r, Object.keys(a || {}).reduce((t, e) => t + "".concat(e, '="').concat(wt(a[e]), '" '), "").trim()), ">").concat(n.map(O).join(""), "</").concat(e, ">")
    }
    ...
    function Rt(t, e, a) {
        var {
            skipHooks: r = !1
        } = 2 < arguments.length && void 0 !== a ? a : {}, n = Dt(e);
        "function" != typeof P.hooks.addPack || r ? P.styles[t] = b(b({}, P.styles[t] || {}), n) : P.hooks.addPack(t, Dt(e)), "fas" === t && Rt("fa", e)
    }
    let {
        styles: N,
        shims: Lt
    } = P, Tt = Object.keys(dt), Yt = Tt.reduce((t, e) => (t[e] = Object.keys(dt[e]), t), {}), S = null, Wt = {}, Ht = {}, _t = {}, Ut = {}, Bt = {};
    ...
    function Kt(t, e) {
        var {
            family: a = l
        } = 1 < arguments.length && void 0 !== e ? e : {}, r = ct[a][t];
    ...
    function Qt(t, e) {
        ...
        return b(b(b({}, o), (t => {
            var {
                ...
                styles: i = {},
                config: o = {}
            } = t, s = a === u, l = e.includes("fa-duotone") || e.includes("fad"), f = "duotone" === o.familyDefault, c = "fad" === r.prefix || "fa-duotone" === r.prefix;
            return !s && (l || f || c) && (r.prefix = "fad"), (e.includes("fa-brands") || e.includes("fab")) && (r.prefix = "fab"), !r.prefix && Zt.includes(a) && (Object.keys(i).find(t => $t.includes(t)) || o.autoFetchSvg) && (s = V.get(a).defaultShortPrefixId, r.prefix = s, r.iconName = E(r.prefix, r.iconName) || r.iconName), "fa" !== r.prefix && "fa" !== n || (r.prefix = S || "fas"), r
        })({
            values: t,
            family: i,
            styles: N,
    ...
    let ne = new class {
            ...
            _pullDefinitions(i, t) {
                ...
                return Object.keys(o).map(t => {
                    ...
                    var n = r[2];
                    i[e] || (i[e] = {}), 0 < n.length && n.forEach(t => {
        ...
        ie = {
            ...
            dom: {
                ...
                watch: function() {
                    ...
                    !1 === x.autoReplaceSvg && (x.autoReplaceSvg = !0), x.observeMutations = !0, Mt(() => {
                        F({
    ...
    function le(t) {
        var {
        ...
        }), s = (s && (l[y] = ""), b({}, o.styles)), o = (At(n) && (s.transform = (t => {
            var {
                transform: e,
                width: a = tt,
                height: r = tt,
            ...
            width: a,
            height: r
        }), s["-webkit-transform"] = s.transform), A(s)), n = (0 < o.length && (l.style = o), []);
        return n.push({
            tag: "span",
            attributes: l,
            children: [e]
    ...
    let ye = {
        ...
        nest: function(t) {
            ...
            delete a[0].attributes.id, a[0].attributes.class && (n = a[0].attributes.class.split(" ").reduce((t, e) => ((e === x.replacementClass || e.match(r) ? t.toSvg : t.toNode).push(e), t), {
                toNode: [],
                toSvg: []
    ...
    function Ne(t) {
        ...
        Oe = new _(t => {
            if (!we) {
                ...
                w(t).forEach(t => {
                    var e, a, r;
                    "childList" === t.type && 0 < t.addedNodes.length && !ve(t.addedNodes[0]) && (x.searchPseudoElements && s(t.target), i(t.target)), "attributes" === t.type && t.target.parentNode && x.searchPseudoElements && s(t.target.parentNode), "attributes" === t.type && ve(t.target) && ~gt.indexOf(t.attributeName) && ("class" === t.attributeName && (e = t.target, a = e.getAttribute ? e.getAttribute(nt) : null, r = e.getAttribute ? e.getAttribute(it) : null, a) && r ? ({
                        prefix: a,
                        iconName: r
                    } = Qt(kt(t.target)), t.target.setAttribute(nt, a || n), r && t.target.setAttribute(it, r)) : (e = t.target) && e.classList && e.classList.contains && e.classList.contains(x.replacementClass) && o(t.target))
                })
            }
        }), f && Oe.observe(e, {
            childList: !0,
    ...
    function Ue(m, h) {
        ...
        return new Promise((s, a) => {
            ...
            if (u && "none" !== t && "" !== t) {
                ...
                n = t, c = n.replace(Te, ""), n = 0, d = (r = c).length, f = (d = 55296 <= (f = r.charCodeAt(n)) && f <= 56319 && n + 1 < d && 56320 <= (d = r.charCodeAt(n + 1)) && d <= 57343 ? 1024 * (f - 55296) + d - 56320 + 65536 : f) >= Ye[0] && d <= Ye[1];
                var {
                    value: c,
                    isSecondary: f
                } = {
                ...
                if (d && (r = c, u = Ut[r], d = qt("fas", r), (c = u || (d ? {
                        ...
                        prefix: null,
                        iconName: null
                    }).iconName) && c.prefix && (e = c.iconName, i = c.prefix), !e || f || l && l.getAttribute(nt) === i && l.getAttribute(it) === o) s();
                else {
                    ...
                    let r = {
                        ...
                        n = r.extra;
                    n.attributes[at] = h, de(e, i).then(t => {
                        var e = se(b(b({}, r), {}, {
                                icons: {
                                    main: t,
                                    mask: Gt()
        ...
        Qe = {
            ...
            provides(t) {
                t.generateAbstractTransformGrouping = function(t) {
                    ...
                    }, i = "translate(".concat(32 * a.x, ", ").concat(32 * a.y, ") "), o = "scale(".concat(a.size / 16 * (a.flipX ? -1 : 1), ", ").concat(a.size / 16 * (a.flipY ? -1 : 1), ") "), a = "rotate(".concat(a.rotate, " 0 0)"), r = {
                        outer: r,
                        inner: {
    ...
    n = [J, Fe, De, Re, Le, Ve, Ke, Qe, {
        ...
        provides(t) {
            t.generateAbstractMask = function(t) {
                var {
                    ...
                    }, n = "translate(".concat(32 * e.x, ", ").concat(32 * e.y, ") "), i = "scale(".concat(e.size / 16 * (e.flipX ? -1 : 1), ", ").concat(e.size / 16 * (e.flipY ? -1 : 1), ") "), e = "rotate(".concat(e.rotate, " 0 0)");
                    return {
                        outer: a,
                        inner: {
        ...
        te = ta, M = {}, Object.keys(j).forEach(t => {
            ...
            if (Object.keys(a).forEach(e => {
                    "function" == typeof a[e] && (r[e] = a[e]), "object" == typeof a[e] && Object.keys(a[e]).forEach(t => {
                        r[e] || (r[e] = {}), r[e][t] = a[e][t]
                    })
                }), t.hooks) {
                let e = t.hooks();
